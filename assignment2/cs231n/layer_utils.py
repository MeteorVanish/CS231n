...
def universal_forward(x, w, b, gamma, beta, bn_param, dropout_param, last_flag):
    """hidden layer: affine - [batch/layer norm] - relu - [dropout], last layer: affine
    """
    cache_affine, cache_bn, cache_ln, cache_relu, cache_dropout = None, None, None, None, None
    ...
    cache = cache_affine, cache_bn, cache_ln, cache_relu, cache_dropout

    return out, cache


def universal_backward(dout, cache):
    """hidden layer: affine - [batch/layer norm] - relu - [dropout], last layer: affine
    """
    dgamma, dbeta = None, None
    cache_affine, cache_bn, cache_ln, cache_relu, cache_dropout = cache

    if cache_dropout is not None:
